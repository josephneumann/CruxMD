...
def upgrade() -> None:
    ...
    op.create_index('ix_fhir_resources_resource_type', 'fhir_resources', ['resource_type'], unique=False)
    op.create_index('ix_fhir_resources_patient_id', 'fhir_resources', ['patient_id'], unique=False)
    # Composite index for type + patient queries
    op.create_index('idx_fhir_type_patient', 'fhir_resources', ['resource_type', 'patient_id'], unique=False)
    # GIN index for JSONB queries
    op.create_index('idx_fhir_data_gin', 'fhir_resources', ['data'], unique=False, postgresql_using='gin')
